  ...
  ${(props) =>
    ...
    css`
      tbody {
        tr {
          &:nth-of-type(2n + 1) {
            background-color: ${tinycolor2(themeGet("colors.gray200")(props))
              .darken(3)
              .toString()};
          }
        }
    ...
    css`
      ...
      tbody {
        tr {
          background-color: ${tinycolor2(themeGet("colors.orange")(props))
            .lighten(45)
            .toString()};
        }
        tr:first-child {
    ...
    css`
      ...
      tbody {
        tr {
          background-color: ${tinycolor2(themeGet("colors.cyan")(props))
            .lighten(55)
            .toString()};
        }
        tr:first-child {
