  ...
  return (
    <StyledWrap>
      <StyledShare>
        ...
        <StyledStatusInput onChange={() => {}} value="Share an Update" />
      </StyledShare>
      <RightBtn>
        <RightBtnLink
          href="#!"
      ...
      <RightBtn>
        <RightBtnLink href="#!" data-for="tooltip-file" data-tip="Publish File">
          <FileText width={18} height={18} />
          <ReactTooltip place="top" effect="solid" id="tooltip-file" />
        </RightBtnLink>
      </RightBtn>
    </StyledWrap>
  );
