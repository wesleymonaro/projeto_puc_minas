    ...
    <Card mb={["20px", null, null, "25px"]}>
      ...
      <CardBody p={["20px", "20px", null, "25px"]}>
        <Row>
          ...
          <Col col={12} sm={6} lg={12} xl={6} mt={["25px", 0, null, "25px", 0]}>
            <Media>
              ...
              <MediaBody ml="25px">
                ...
                <Text fontSize="12px" mb="10px">
                  Online social media and social networking service company...{" "}
                  <Anchor path="#!">Learn More</Anchor>
                </Text>
                <Text fontSize="12px" color="text3">
          ...
          <Col col={12} sm={6} lg={12} xl={6} mt="25px">
            <Media>
              ...
              <MediaBody ml="25px">
                ...
                <Text fontSize="12px" mb="10px">
                  Logistics company providing international courier service...{" "}
                  <Anchor path="#!">Learn More</Anchor>
                </Text>
                <Text fontSize="12px" color="text3">
                  3,005,192 Followers
          ...
          <Col col={12} sm={6} lg={12} xl={6} mt="25px">
            <Media>
              ...
              <MediaBody ml="25px">
                ...
                <Text fontSize="12px" mb="10px">
                  Photo and video-sharing social networking service by
                  Facebook... <Anchor path="#!">Learn More</Anchor>
                </Text>
                <Text fontSize="12px" color="text3">
                  3,005,192 Followers
                </Text>
