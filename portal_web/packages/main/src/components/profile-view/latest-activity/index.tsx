  ...
  return (
    <StyledCard mb={["20px", null, null, "25px"]}>
      ...
      <CardBody p={["20px", "20px", null, "25px"]}>
        ...
        <Text mb="20px">
          Our team is expanding again. We are looking for a Product Manager and
          Software Engineer to drive our new aspects of our capital projects. If
          you&apos;re interested, please drop a comment here or simply message
          me. <a href="#!">#softwareengineer</a> <a href="#!">#engineering</a>
        </Text>
        <StyledGrayBox>
