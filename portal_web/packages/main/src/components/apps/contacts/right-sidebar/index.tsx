  ...
  return (
    <StyledWrap>
      <StyledTopDiv>
        ...
        <StyledClose className="sidebar-close" type="button" onClick={onClose}>
          <X />
        </StyledClose>
      </StyledTopDiv>
      ...
      <StyledBtns>
        ...
        <ReactTooltip place="top" effect="solid" id="tooltip-umessage" />
      </StyledBtns>
      <Label>Biography</Label>
      <StyledBio>
        Gambler, Tea Drinker, Ultimate Piggie, Replacement President of a Major
        Soft Drink Manufacturer. When I give out candies, I give people the
