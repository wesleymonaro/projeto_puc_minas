  ...
  useEffect(() => {
    setValues((prev) => {
      return {
        ...
        createEndDate: moment(currentDate.end.toString()).format("YYYY-MM-DD"),
      };
    });
  }, [currentDate]);
    ...
    <Modal show={show} onClose={onClose}>
      <ModalBody p={["20px", "30px"]}>
        ...
        <form className="create-event-form">
          ...
          <StyledGroup mt={30}>
            <StyledLabel htmlFor="createStartDate">Start Date</StyledLabel>
            <Row gutters={10}>
              <Col col={7}>
                <DatePicker
                  id="createStartDate"
          ...
          <StyledGroup mt={30}>
            <StyledLabel htmlFor="createEndDate">End Date</StyledLabel>
            <Row gutters={10}>
              <Col col={7}>
                <DatePicker
                  id="createEndDate"
          ...
          <StyledGroup>
            ...
            >
              ...
              {events.map((event) => (
                <option value={event.category} key={event.category}>
                  {event.category}
                </option>
              ))}
            </Select>
