...
const SettingsCard: FC<IProps> = ({ themeHandler, curTheme }) => {
  ...
  return (
    <StyledSettings $show={show}>
      <StyledSettingsBtn $show={show} onClick={() => setShow((prev) => !prev)}>
      ...
      <StyledSettingsBody>
        ...
        <StyledCard $hasBorder>
          ...
          <Row gutters={10}>
            <Col xs={6} sm={6}>
              <StyledNavLink href={`${location}/`}>Horizontal</StyledNavLink>
            </Col>
            <Col xs={6} sm={6}>
              <StyledNavLink href={`${location}/classic-plus/dashboard-one`}>
                Vertical
              </StyledNavLink>
            </Col>
          </Row>
