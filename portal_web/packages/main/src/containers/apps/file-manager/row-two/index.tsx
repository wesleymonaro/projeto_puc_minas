...
const RowOne: FC = () => {
  return (
    <>
      ...
      <Row gutters={10}>
        <Col sm={6} lg={4} xl={3}>
          <FolderPreview title="Downloads" link="#!" files={2} size="14.05mb" />
        </Col>
        ...
        <Col sm={6} lg={4} xl={3} mt={["10px", null, null, null, 0]}>
          <FolderPreview title="Recordings" link="#!" files={0} size="" />
        </Col>
        <Col sm={6} lg={4} xl={3} mt="10px">
          <FolderPreview title="Support" link="#!" files={1} size="20mb" />
        </Col>
      </Row>
    </>
  );
